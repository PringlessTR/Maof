        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppSetting_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostBefore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CostAfter = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TaxRateBefore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TaxRateAfter = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SyncBatches_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncBatches_StoreId",
                table: "SyncBatches",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_SyncBatches_UserId",
                table: "SyncBatches",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SyncLogs_StoreId",
                table: "SyncLogs",
                column: "StoreId");
